...
def get_rule_run_transform_SNPs_into_canonical_SNPs(output_folder):
    nb_of_genomes = 4
    return [f"{output_folder}/genome_{i}.genome_{j}.canonical_snps" for i in range(nb_of_genomes) for j in range(nb_of_genomes)]
